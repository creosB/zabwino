    ...
    <>
      <div className='search-header mb-3 container-fluid'>
        <div className='row search'>
          <p className='header-text text-center me-2 d-flex justify-content-center' style={{ fontWeight: 'semi-bold', color: 'black' }}>
            Searching for&nbsp;
            {categoryName ? categoryName : <span style={{ fontWeight: 'semi-bold', color: 'black' }}>Products</span>}&nbsp;in&nbsp;
            {locationName ? locationName : <span style={{ fontWeight: 'semi-bold', color: 'black' }}>Malawi</span>}
          </p>
