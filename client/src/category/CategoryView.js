              ...
              <div className='row category-header'>
                <div className='col-md-8 pt-2'>
                  {products.length > 0 && (
                    ...
                    >
                      {location === '' && (
                        <span>{products[0].category.name} in Malawi</span>
                      )}
                      {location !== '' && (
                        <span>
                          ...
                          <div class='col-md-3 product-img embed-responsive embed-responsive-16by9'>
                              ...
                              <Tooltip title='Remove from Favourites'>
                                ...
                                >
                                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24">
                                    <polygon points="12 2 15.09 8.29 22 9.82 17 14 18.18 21.73 12 19.5 5.82 21.73 7 14 2 9.82 8.91 8.29 12 2" fill="yellow" stroke="yellow" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                                  </svg>
                            ...
                            {user && token && !favourites.includes(p._id) && (
                              <Tooltip title='Add to Favourites'>
                                ...
                                >
                                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24">
                                    <polygon points="12 2 15.09 8.29 22 9.82 17 14 18.18 21.73 12 19.5 5.82 21.73 7 14 2 9.82 8.91 8.29 12 2" fill="rgba(0, 0, 0, 0.125)" stroke="yellow" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                                  </svg>
